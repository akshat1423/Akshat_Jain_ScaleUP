...
-- Date: 2024-12-19
-- Features: File uploads, message reactions, likes, replies, poll/announcement references
...
-- =============================================
-- AUTOMATIC FILE METADATA TRIGGER
-- =============================================
...
COMMENT ON COLUMN community_chat_messages.poll_id IS 'Reference to poll for poll request messages';
COMMENT ON COLUMN community_chat_messages.announcement_id IS 'Reference to announcement for reminder messages';
COMMENT ON COLUMN community_chat_messages.reply_to_message_id IS 'Reference to the message being replied to';
...
/*
SCHEMA v3.0 FEATURES:

1. FILE UPLOAD SYSTEM:
   - Storage buckets for images, audio, and documents
   - File metadata tracking (name, size, type, MIME type)
...
2. MESSAGE INTERACTIONS:
   ...
   - Message likes system
   - Reply functionality
   - Poll and announcement reference support
